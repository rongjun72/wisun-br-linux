...
////
/////* Register meter */
////uint32_t sl_wisun_collector_register_meter(const sockaddr_in6_t *meter_addr)
////{
...
////
/////* Remove meter */
////uint32_t sl_wisun_collector_remove_meter(const sockaddr_in6_t *meter_addr)
////{
////  const sl_mempool_block_hnd_t *block           = NULL;
...
////}
////
////uint32_t sl_wisun_send_async_request(const sockaddr_in6_t *meter_addr)
////{
////  const sl_mempool_block_hnd_t *block     = NULL;
////  sl_wisun_meter_entry_t *tmp_meter_entry = NULL;
////  uint32_t res                         = SL_STATUS_FAIL;
