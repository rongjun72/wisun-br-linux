...
# -----------------------------------------------------------------------
# Test case :   Border Router as DUT [DIRECT-HASH-HOP-LBR-1]
# -----------------------------------------------------------------------
# Description:  
# This test case verifies the channel hop sequence required for Wi-SUN 
# FAN implementations using the Direct Hash Channel Function. For this 
# test case, the Regulatory Domain is used (should be set to 0x1) with 
# Operating Class of 2 (400 Khz channel spacing).  The data rate is 
# 150kbps for this section of tests.
# -----------------------------------------------------------------------
# Test Bed Configuration:
# The TBU’s in the test are all configured for the Direct Hash Channel 
# Function using a Unicast Dwell Interval of 255ms.
