...
# -----------------------------------------------------------------------
# Test case :   Border Router as DUT [DIRECT-EXC-CHAN-SEND-LBR-1]
# -----------------------------------------------------------------------
# Description:  
...
# CH0/Channel Spacing/Number of Channels format.  In addition, for this 
# test case, the test bed devices using the Regional Domain/Operating 
# class will present an Excluded Channel list as a list of 2 ranges 
# while the test bed devices using the CH0/Channel Spacing/Number of 
# Channels will present an Excluded Channel list as a mask.
# -----------------------------------------------------------------------
# The Test bed devices A-B in the test are configured for the Direct 
...
# [DIRECT-MIXED-DWELL-LBR-1] except:
#   1. Test bed devices A-B will use North America Channel Plan 
#       (Regulatory Domain, value of 1), Operating Class of 2 (400 Khz 
#       channel spacing, data rate of 150 kbps (same as [DIRECT-MIXED-DWELL-LBR-1] 
#       but will use Excluded channel ranges of 10-20 and 50-60
#   2. Test bed devices C-D will use CH0 of 902400, Channel spacing of 
#       400 Khz (value of 1), Number of channels as 64 including an 
#       excluded channel mask of 0x0A1B2C3D00004E5F
...
# -----------------------------------------------------------------------
TEST_CASE_NAME="DIRECT-EXC-CHAN-SEND-LBR-1"
...
if [ "$debug_option" = "DEBUG_ANALYSIS" ]; then
    ...
    WISUN_NODE0_CONFIG=("disconnect" "yes" "domain" $wisun_domain "mode" $wisun_mode "class" $wisun_class 
        "unicast_dwell_interval" 15 "allowed_channels" "0-10,30-40" "allowed_mac64" $BRRPI_mac "allowed_mac64" $wsnode1_mac);
