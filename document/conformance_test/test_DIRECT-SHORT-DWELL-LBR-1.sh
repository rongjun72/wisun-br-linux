...
# -----------------------------------------------------------------------
# Test case :   Border Router as DUT [DIRECT-SHORT-DWELL-LBR-1]
# -----------------------------------------------------------------------
# Description:  
# Note:  This test case is identical to the test case [DIRECT-HASH-HOP-LBR-1] 
# except a dwell interval of 15 ms is used for the LBR and all Test bed devices.
#
# This test case verifies the channel hop sequence required for Wi-SUN 
# FAN implementation using the Direct Hash Channel Function.   
# The Regulatory Domain should be set to 0x1, Operating Class 2 
# (400 Khz channel spacing) and the data rate as 150kbps 
# for this section of tests..
# -----------------------------------------------------------------------
# The TBU’s in the test are all configured for the Direct Hash Channel 
# Function using a dwell interval of 15ms. The DUT is similarly 
# configured for the Direct Hash Channel function but using a DUT 
# specific dwell interval.
...
# -----------------------------------------------------------------------
TEST_CASE_NAME="DIRECT-SHORT-DWELL-LBR-1"
...
if [ "$debug_option" = "DEBUG_ANALYSIS" ]; then
    ...
    "unicast_dwell_interval" 15 "allowed_channels" "0-255" "allowed_mac64--" $wsnode0_mac);
